...
- Here are the traditional rating factors that we use. Note that we include the real distance driven since it is a telematics feature known to have a lot of predictive power.
...
| GLM (only traditional rating factors) | 1.47 % | 3.21 % |
| GLM (traditional rating factors + handcrafted telematics features) | 1.72 % | 3.64 % |
| CANN | 1.78 % | 3.66 % |
