...
class: title-slide
background-image: url(xaringan/images/logo_chaire.jpg), url(xaringan/images/background.jpg)
...
knitr::include_graphics("xaringan/images/tele_icon.png")
```

```{r echo = F, out.width = "65%", fig.align = "center"}
knitr::include_graphics("xaringan/images/brain_icon.png")
```

```{r echo = F, out.width = "60%", fig.align = "center"}
knitr::include_graphics("xaringan/images/nn_icon.png")
```
]
...
knitr::include_graphics("xaringan/images/CANN.png")
```
...
background-image: url(xaringan/images/perceptron.png)
background-size: 75%
...
background-image: url(xaringan/images/PoissonCANN.png)
background-size: 60%
...
knitr::include_graphics("xaringan/images/PoissonCANN_legend.png")
```
<br>
<br>
<br>
